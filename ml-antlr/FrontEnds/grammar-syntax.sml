...
structure GrammarSyntax =
  struct
    ...
    fun updHeader (g, new) = let
          val GRAMMAR {import, importChanges, header, defs, rules, toks, actionStyle, startSym, entryPoints, keywords} = g
          in GRAMMAR {import = import, importChanges = importChanges, header = new, defs = defs, rules = rules, 
		      toks = toks, actionStyle = actionStyle, startSym = startSym, entryPoints = entryPoints, keywords = keywords} end
    ...
    fun updToks (g, new) = let
          ...
          in GRAMMAR {import = import, importChanges = importChanges, header = header, defs = defs, rules = rules, 
		      toks = new, actionStyle = actionStyle, startSym = startSym, entryPoints = entryPoints, keywords = keywords} end

    fun updActionStyle (g, new) = let
          val GRAMMAR {import, importChanges, header, defs, rules, toks, actionStyle, startSym, entryPoints, keywords} = g
          in GRAMMAR {import = import, importChanges = importChanges, header = header, defs = defs, rules = rules, 
		      toks = toks, actionStyle = new, startSym = startSym, entryPoints = entryPoints, keywords = keywords} end
    ...
    fun updImport (GRAMMAR {import = NONE, importChanges, header, defs, rules, toks, actionStyle, startSym, entryPoints, keywords}, new) =
          GRAMMAR {import = SOME new, importChanges = importChanges, header = header, defs = defs, rules = rules, 
		   toks = toks, actionStyle = actionStyle, startSym = startSym, entryPoints = entryPoints, keywords = keywords}
      | updImport (g, _) = (Err.errMsg ["Error: multiple %imports are not allowed"]; g)

    fun updStartSym (GRAMMAR {import = import, importChanges, header, defs, rules, toks, actionStyle, startSym = NONE, entryPoints, keywords}, new) =
          GRAMMAR {import = import, importChanges = importChanges, header = header, defs = defs, rules = rules, 
		   toks = toks, actionStyle = actionStyle, startSym = SOME new, entryPoints = entryPoints, keywords = keywords}
      | updStartSym (g, _) = (Err.errMsg ["Error: multiple %start symbols are not allowed"]; g)

    fun updEntryPoints (GRAMMAR {import = import, importChanges, header, defs, rules, toks, actionStyle, startSym, entryPoints = [], keywords}, new) =
          GRAMMAR {import = import, importChanges = importChanges, header = header, defs = defs, rules = rules, 
		   toks = toks, actionStyle = actionStyle, startSym = startSym, entryPoints = new, keywords = keywords}
      | updEntryPoints (g, _) = (Err.errMsg ["Error: multiple %entry directives not allowed"]; g)

    fun updKeywords (GRAMMAR {import = import, importChanges, header, defs, rules, toks, actionStyle, startSym, entryPoints = entryPoints, keywords = []}, new) =
          GRAMMAR {import = import, importChanges = importChanges, header = header, defs = defs, rules = rules, 
		   toks = toks, actionStyle = actionStyle, startSym = startSym, entryPoints = entryPoints, keywords = new}
