...
fun yyQ7 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ110 (strm, lastMatch) = yyAction50(strm, yyNO_MATCH)
fun yyQ111 (strm, lastMatch) = yyAction51(strm, yyNO_MATCH)
fun yyQ112 (strm, lastMatch) = yyAction52(strm, yyNO_MATCH)
fun yyQ113 (strm, lastMatch) = yyAction56(strm, yyNO_MATCH)
            ...
            if inp = #"*"
              ...
              then if inp = #"#"
                  ...
                  then if inp = #"\""
                      ...
                      else yyQ115(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp <= #"'"
                  then yyQ115(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
...
fun yyQ114 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ117 (strm, lastMatch) = yyAction53(strm, yyNO_MATCH)
fun yyQ118 (strm, lastMatch) = yyAction54(strm, yyNO_MATCH)
...
fun yyQ6 (strm, lastMatch) = (case (yygetc(strm))
        ...
        | SOME(inp, strm') =>
            if inp = #")"
              ...
              then if inp = #"\""
                  ...
                  then if inp = #"\n"
                      then yyQ115(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                      else yyQ114(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp = #"("
      ...
      (* end case *))
fun yyQ103 (strm, lastMatch) = yyAction46(strm, yyNO_MATCH)
fun yyQ104 (strm, lastMatch) = yyAction46(strm, yyNO_MATCH)
fun yyQ105 (strm, lastMatch) = yyAction47(strm, yyNO_MATCH)
fun yyQ106 (strm, lastMatch) = yyAction48(strm, yyNO_MATCH)
fun yyQ107 (strm, lastMatch) = yyAction49(strm, yyNO_MATCH)
fun yyQ43 (strm, lastMatch) = yyAction58(strm, yyNO_MATCH)
...
fun yyQ5 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ99 (strm, lastMatch) = yyAction37(strm, yyNO_MATCH)
fun yyQ100 (strm, lastMatch) = yyAction39(strm, yyNO_MATCH)
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"b"
              ...
              then yyQ32(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"t"
              then yyQ30(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
              else yyQ31(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
      (* end case *))
fun yyQ102 (strm, lastMatch) = yyAction36(strm, yyNO_MATCH)
...
fun yyQ4 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ98 (strm, lastMatch) = yyAction40(strm, yyNO_MATCH)
fun yyQ3 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ90 (strm, lastMatch) = yyAction31(strm, yyNO_MATCH)
fun yyQ91 (strm, lastMatch) = yyAction31(strm, yyNO_MATCH)
fun yyQ92 (strm, lastMatch) = yyAction34(strm, yyNO_MATCH)
fun yyQ93 (strm, lastMatch) = yyAction35(strm, yyNO_MATCH)
...
fun yyQ41 (strm, lastMatch) = yyAction2(strm, yyNO_MATCH)
fun yyQ42 (strm, lastMatch) = yyAction13(strm, yyNO_MATCH)
...
fun yyQ44 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ46 (strm, lastMatch) = yyAction3(strm, yyNO_MATCH)
fun yyQ88 (strm, lastMatch) = yyAction6(strm, yyNO_MATCH)
...
fun yyQ47 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ80 (strm, lastMatch) = yyAction11(strm, yyNO_MATCH)
...
fun yyQ48 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ77 (strm, lastMatch) = yyAction10(strm, yyNO_MATCH)
...
fun yyQ49 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ71 (strm, lastMatch) = yyAction9(strm, lastMatch)
...
fun yyQ50 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ66 (strm, lastMatch) = yyAction8(strm, yyNO_MATCH)
...
fun yyQ51 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ62 (strm, lastMatch) = yyAction7(strm, yyNO_MATCH)
...
fun yyQ52 (strm, lastMatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ59 (strm, lastMatch) = yyAction5(strm, yyNO_MATCH)
