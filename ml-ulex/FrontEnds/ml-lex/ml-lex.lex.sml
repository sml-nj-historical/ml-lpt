...
fun yyAction46 (strm, lastMatch : yymatch) = (yystrm := strm; (lex()))
...
fun yyQ123 (strm, lastMatch : yymatch) = yyAction0(strm, yyNO_MATCH)
fun yyQ122 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
and yyQ124 (strm, lastMatch : yymatch) = (case (yygetc(strm))
...
fun yyQ121 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"%"
              then yyQ123(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
              else yyQ122(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
      (* end case *))
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"\v"
              then yyQ119(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp < #"\v"
              then if inp = #"\n"
                  then yyQ120(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
                  else yyQ119(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #"%"
              then yyQ121(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
              else yyQ119(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
      (* end case *))
fun yyQ118 (strm, lastMatch : yymatch) = yyAction54(strm, yyNO_MATCH)
fun yyQ117 (strm, lastMatch : yymatch) = yyAction53(strm, yyNO_MATCH)
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #"\""
                  then yyQ117(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                  else yyAction55(strm, yyNO_MATCH)
            else if inp = #"\\"
              then yyQ118(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
              else yyAction55(strm, yyNO_MATCH)
      (* end case *))
fun yyQ115 (strm, lastMatch : yymatch) = yyAction50(strm, yyNO_MATCH)
fun yyQ114 (strm, lastMatch : yymatch) = yyAction52(strm, yyNO_MATCH)
fun yyQ113 (strm, lastMatch : yymatch) = yyAction51(strm, yyNO_MATCH)
fun yyQ112 (strm, lastMatch : yymatch) = yyAction56(strm, yyNO_MATCH)
fun yyQ111 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ111(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"*"
              then if inp = #"#"
                  then yyQ111(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp < #"#"
                  then if inp = #"\""
                      ...
                      else yyQ111(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp <= #"'"
                  then yyQ111(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
...
fun yyQ6 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #")"
              then yyQ114(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #")"
              then if inp = #"\""
                  ...
                  then yyQ113(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyQ110(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp = #"<"
              then yyQ110(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"<"
              then if inp = #";"
                  then yyQ115(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyQ110(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp = #"\\"
...
fun yyQ108 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ107 (strm, lastMatch : yymatch) = yyAction48(strm, yyNO_MATCH)
fun yyQ106 (strm, lastMatch : yymatch) = yyAction49(strm, yyNO_MATCH)
fun yyQ105 (strm, lastMatch : yymatch) = yyAction47(strm, yyNO_MATCH)
fun yyQ104 (strm, lastMatch : yymatch) = yyAction46(strm, yyNO_MATCH)
fun yyQ103 (strm, lastMatch : yymatch) = yyAction46(strm, yyNO_MATCH)
fun yyQ40 (strm, lastMatch : yymatch) = yyAction58(strm, yyNO_MATCH)
fun yyQ5 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ101 (strm, lastMatch : yymatch) = yyAction39(strm, yyNO_MATCH)
fun yyQ100 (strm, lastMatch : yymatch) = yyAction37(strm, yyNO_MATCH)
fun yyQ35 (strm, lastMatch : yymatch) = yyAction42(strm, yyNO_MATCH)
...
fun yyQ31 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ32(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ32(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                else if inp < #"0"
      ...
      (* end case *))
fun yyQ37 (strm, lastMatch : yymatch) = yyAction41(strm, yyNO_MATCH)
...
fun yyQ30 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ29 (strm, lastMatch : yymatch) = yyAction41(strm, yyNO_MATCH)
fun yyQ28 (strm, lastMatch : yymatch) = yyAction43(strm, yyNO_MATCH)
fun yyQ25 (strm, lastMatch : yymatch) = (case (yygetc(strm))
              ...
              then if inp = #"#"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp = #"\n"
                          ...
                          else yyQ28(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                    else if inp = #"\""
                      then yyQ29(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                      else yyQ28(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyQ28(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                      else yyQ30(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp = #"\\"
                  then yyQ29(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                  else yyQ28(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"s"
      ...
      (* end case *))
fun yyQ102 (strm, lastMatch : yymatch) = yyAction36(strm, yyNO_MATCH)
fun yyQ99 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"]"
              then yyQ102(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
              else yyAction38(strm, yyNO_MATCH)
      (* end case *))
fun yyQ8 (strm, lastMatch : yymatch) = yyAction44(strm, yyNO_MATCH)
fun yyQ4 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ98 (strm, lastMatch : yymatch) = yyAction40(strm, yyNO_MATCH)
fun yyQ3 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ95 (strm, lastMatch : yymatch) = yyAction35(strm, yyNO_MATCH)
...
fun yyQ93 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ92 (strm, lastMatch : yymatch) = yyAction34(strm, yyNO_MATCH)
fun yyQ91 (strm, lastMatch : yymatch) = yyAction31(strm, yyNO_MATCH)
fun yyQ90 (strm, lastMatch : yymatch) = yyAction31(strm, yyNO_MATCH)
...
fun yyQ45 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ44 (strm, lastMatch : yymatch) = yyAction13(strm, yyNO_MATCH)
fun yyQ60 (strm, lastMatch : yymatch) = yyAction10(strm, yyNO_MATCH)
...
fun yyQ54 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ68 (strm, lastMatch : yymatch) = yyAction6(strm, yyNO_MATCH)
...
fun yyQ53 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ73 (strm, lastMatch : yymatch) = yyAction9(strm, lastMatch)
...
fun yyQ52 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ79 (strm, lastMatch : yymatch) = yyAction5(strm, yyNO_MATCH)
...
fun yyQ51 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ82 (strm, lastMatch : yymatch) = yyAction11(strm, yyNO_MATCH)
...
fun yyQ50 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ86 (strm, lastMatch : yymatch) = yyAction8(strm, yyNO_MATCH)
...
fun yyQ49 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ89 (strm, lastMatch : yymatch) = yyAction7(strm, yyNO_MATCH)
...
fun yyQ48 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ47 (strm, lastMatch : yymatch) = yyAction3(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"g"
              ...
              then if inp = #"i"
                  ...
                  then yyQ51(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                else if inp = #"r"
...
fun yyQ41 (strm, lastMatch : yymatch) = yyAction2(strm, yyNO_MATCH)
fun yyQ1 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ27 (strm, lastMatch : yymatch) = yyAction18(strm, yyNO_MATCH)
fun yyQ26 (strm, lastMatch : yymatch) = yyAction24(strm, yyNO_MATCH)
fun yyQ24 (strm, lastMatch : yymatch) = yyAction26(strm, yyNO_MATCH)
fun yyQ23 (strm, lastMatch : yymatch) = yyAction15(strm, yyNO_MATCH)
fun yyQ22 (strm, lastMatch : yymatch) = yyAction28(strm, yyNO_MATCH)
fun yyQ39 (strm, lastMatch : yymatch) = yyAction29(strm, yyNO_MATCH)
...
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ20 (strm, lastMatch : yymatch) = yyAction27(strm, yyNO_MATCH)
fun yyQ19 (strm, lastMatch : yymatch) = yyAction30(strm, yyNO_MATCH)
fun yyQ18 (strm, lastMatch : yymatch) = yyAction22(strm, yyNO_MATCH)
fun yyQ17 (strm, lastMatch : yymatch) = yyAction23(strm, yyNO_MATCH)
fun yyQ16 (strm, lastMatch : yymatch) = yyAction17(strm, yyNO_MATCH)
fun yyQ15 (strm, lastMatch : yymatch) = yyAction16(strm, yyNO_MATCH)
fun yyQ14 (strm, lastMatch : yymatch) = yyAction20(strm, yyNO_MATCH)
fun yyQ13 (strm, lastMatch : yymatch) = yyAction19(strm, yyNO_MATCH)
fun yyQ12 (strm, lastMatch : yymatch) = yyAction21(strm, yyNO_MATCH)
fun yyQ11 (strm, lastMatch : yymatch) = yyAction25(strm, yyNO_MATCH)
fun yyQ10 (strm, lastMatch : yymatch) = yyAction14(strm, yyNO_MATCH)
