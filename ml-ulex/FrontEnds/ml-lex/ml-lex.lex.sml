...
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm; (lex()))
...
fun yyQ124 (strm, lastMatch : yymatch) = yyAction0(strm, yyNO_MATCH)
...
and yyQ121 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"%"
              then yyQ125(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
              else yyQ126(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
      (* end case *))
...
fun yyQ122 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"%"
              then yyQ124(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyQ123(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
      (* end case *))
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ119 (strm, lastMatch : yymatch) = yyAction55(strm, yyNO_MATCH)
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #"\""
                  then yyQ118(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyAction56(strm, yyNO_MATCH)
            else if inp = #"\\"
              then yyQ119(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
              else yyAction56(strm, yyNO_MATCH)
      (* end case *))
fun yyQ116 (strm, lastMatch : yymatch) = yyAction51(strm, yyNO_MATCH)
fun yyQ115 (strm, lastMatch : yymatch) = yyAction53(strm, yyNO_MATCH)
fun yyQ114 (strm, lastMatch : yymatch) = yyAction52(strm, yyNO_MATCH)
fun yyQ113 (strm, lastMatch : yymatch) = yyAction57(strm, yyNO_MATCH)
fun yyQ112 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ112(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp < #"*"
              then if inp = #"#"
                  then yyQ112(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                else if inp < #"#"
                  then if inp = #"\""
                      ...
                      else yyQ112(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                else if inp <= #"'"
                  then yyQ112(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
...
fun yyQ6 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #")"
              then yyQ115(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp < #")"
              then if inp = #"\""
                  ...
                  then if inp = #"\n"
                      then yyQ112(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                      else yyQ111(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                else if inp = #"("
                  then yyQ114(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                  else yyQ111(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp = #"<"
              then yyQ111(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp < #"<"
              then if inp = #";"
                  then yyQ116(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                  else yyQ111(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp = #"\\"
              then yyQ117(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
              else yyQ111(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
      (* end case *))
...
fun yyQ109 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ108 (strm, lastMatch : yymatch) = yyAction49(strm, yyNO_MATCH)
fun yyQ107 (strm, lastMatch : yymatch) = yyAction50(strm, yyNO_MATCH)
fun yyQ106 (strm, lastMatch : yymatch) = yyAction48(strm, yyNO_MATCH)
fun yyQ105 (strm, lastMatch : yymatch) = yyAction47(strm, yyNO_MATCH)
fun yyQ104 (strm, lastMatch : yymatch) = yyAction47(strm, yyNO_MATCH)
...
fun yyQ5 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ102 (strm, lastMatch : yymatch) = yyAction40(strm, yyNO_MATCH)
fun yyQ101 (strm, lastMatch : yymatch) = yyAction38(strm, yyNO_MATCH)
fun yyQ36 (strm, lastMatch : yymatch) = yyAction43(strm, yyNO_MATCH)
...
fun yyQ32 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ33(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ33(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp < #"0"
      ...
      (* end case *))
fun yyQ38 (strm, lastMatch : yymatch) = yyAction42(strm, yyNO_MATCH)
...
fun yyQ31 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ37(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp < #"0"
              then yyAction44(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ37(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
      ...
      (* end case *))
fun yyQ30 (strm, lastMatch : yymatch) = yyAction42(strm, yyNO_MATCH)
fun yyQ29 (strm, lastMatch : yymatch) = yyAction44(strm, yyNO_MATCH)
fun yyQ25 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"b"
              then yyQ30(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"b"
              then if inp = #"#"
                  then yyQ29(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp < #"#"
                  then if inp = #"\v"
                      then yyQ29(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                    else if inp < #"\v"
                      then if inp = #"\n"
                          ...
                          else yyQ29(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                    else if inp = #"\""
                      then yyQ30(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                      else yyQ29(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyQ29(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                      else yyQ31(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp = #"\\"
                  then yyQ30(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                  else yyQ29(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"s"
              ...
              then yyQ32(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"t"
              then yyQ30(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyQ29(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
      (* end case *))
...
fun yyQ100 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"]"
              then yyQ103(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
...
fun yyQ94 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ93 (strm, lastMatch : yymatch) = yyAction35(strm, yyNO_MATCH)
fun yyQ92 (strm, lastMatch : yymatch) = yyAction32(strm, yyNO_MATCH)
...
fun yyQ61 (strm, lastMatch : yymatch) = yyAction10(strm, yyNO_MATCH)
...
fun yyQ55 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ69 (strm, lastMatch : yymatch) = yyAction6(strm, yyNO_MATCH)
...
fun yyQ54 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ74 (strm, lastMatch : yymatch) = yyAction9(strm, lastMatch)
...
fun yyQ53 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ80 (strm, lastMatch : yymatch) = yyAction5(strm, yyNO_MATCH)
...
fun yyQ52 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ83 (strm, lastMatch : yymatch) = yyAction11(strm, yyNO_MATCH)
...
fun yyQ51 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ87 (strm, lastMatch : yymatch) = yyAction8(strm, yyNO_MATCH)
...
fun yyQ50 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ90 (strm, lastMatch : yymatch) = yyAction7(strm, yyNO_MATCH)
...
fun yyQ49 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ48 (strm, lastMatch : yymatch) = yyAction3(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"g"
              ...
              then if inp = #"i"
                  ...
                  then yyQ53(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
                  else yyAction59(strm, yyNO_MATCH)
            else if inp = #"u"
              then yyQ55(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
fun yyQ43 (strm, lastMatch : yymatch) = yyAction2(strm, yyNO_MATCH)
...
fun yyQ1 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ28 (strm, lastMatch : yymatch) = yyAction18(strm, yyNO_MATCH)
fun yyQ27 (strm, lastMatch : yymatch) = yyAction25(strm, yyNO_MATCH)
fun yyQ26 (strm, lastMatch : yymatch) = yyAction24(strm, yyNO_MATCH)
fun yyQ24 (strm, lastMatch : yymatch) = yyAction27(strm, yyNO_MATCH)
fun yyQ23 (strm, lastMatch : yymatch) = yyAction15(strm, yyNO_MATCH)
fun yyQ22 (strm, lastMatch : yymatch) = yyAction29(strm, yyNO_MATCH)
fun yyQ40 (strm, lastMatch : yymatch) = yyAction30(strm, yyNO_MATCH)
...
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
fun yyQ20 (strm, lastMatch : yymatch) = yyAction28(strm, yyNO_MATCH)
fun yyQ19 (strm, lastMatch : yymatch) = yyAction31(strm, yyNO_MATCH)
...
fun yyQ11 (strm, lastMatch : yymatch) = yyAction26(strm, yyNO_MATCH)
