...
\lstdefinelanguage{MLAntlr}[]{SML}{%
  moredirectives={defs,entry,header,import,keywords,name,nonterms,refcell,tokens,start,value},
  moredelim=*[directive]\%,%
  alsoletter={_},
}[keywords,comments,strings,directives]%
...
\lstset{
  ...
  directivestyle=\color{\kwColor}\bfseries,
